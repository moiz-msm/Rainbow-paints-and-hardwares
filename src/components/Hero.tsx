...
export default function Hero() {
  return (
    <section className="relative min-h-[100dvh] lg:min-h-[700px] lg:h-screen lg:max-h-[850px] flex flex-col justify-center lg:justify-center pt-[100px] sm:pt-[140px] lg:pt-[110px] pb-[12dvh] sm:pb-12 lg:pb-24 overflow-hidden bg-transparent">

...
const ShadeCard = memo(({ shade, onSelect, textColor, isFavorite, onToggleFavorite, isSelected }: { 
  ...
  >
    ...
    <div className="bg-[#faf9f6] p-1.5 sm:p-2.5 text-center flex flex-col justify-center items-center gap-0.5 border-t border-zinc-100 shrink-0">
       ...
       <p className="text-[7px] sm:text-[8px] md:text-[8.5px] text-ivory/60 font-mono tracking-wider">{shade.shadeCode}</p>
    </div>
  </div>
));
      ...
      <div className="max-w-7xl xl:max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex justify-center mb-8 relative z-20">
          <div className="flex items-center gap-1.5 border border-zinc-200 bg-[#fdfbf7]/95 p-1 rounded-full shadow-sm max-w-md w-full sm:w-auto">
            <button 
              ...
              className={`flex-1 sm:flex-none px-5 py-2.5 text-[10px] font-sans font-semibold uppercase tracking-widest rounded-full transition-all flex items-center justify-center gap-2 ${visualizerMode === '3d' ? 'bg-gold text-white shadow-md' : 'text-ivory/60 hover:text-gold hover:bg-gold/5'}`}
            >
              <Sparkles className={`w-3.5 h-3.5 ${visualizerMode === '3d' ? 'text-white' : 'text-gold'}`} /> Preview Model
            </button>
            <button 
              onClick={() => setVisualizerMode('ai')}
              className={`flex-1 sm:flex-none px-5 py-2.5 text-[10px] font-sans font-semibold uppercase tracking-widest rounded-full transition-all flex items-center justify-center gap-2 ${visualizerMode === 'ai' ? 'bg-gold text-white shadow-md' : 'text-ivory/60 hover:text-gold hover:bg-gold/5'}`}
            >
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-[10px] sm:text-[11px] font-sans font-bold uppercase tracking-widest text-ivory flex items-center gap-2 leading-none">
                {visualizerMode === 'ai' ? 'Custom Shade Visualiser' : '3D Showroom Models'}
              </h2>
              <p className="text-[9px] text-[#cca564] font-medium leading-none mt-1 flex-1">
            ...
            <div className="border-b border-zinc-200/50 flex flex-col gap-3.5 p-3.5 shrink-0">
              ...
              <div className="relative shrink-0 pt-1">
                ...
                <div className="flex items-center gap-3 bg-white border border-zinc-150 p-2.5 rounded-xl shadow-3xs">
                  ...
                  <div className="flex-grow min-w-0">
                    <h3 className="text-[10px] sm:text-[11px] font-sans font-bold uppercase tracking-widest text-ivory leading-none mb-0.5 truncate">{activeShade ? activeShade.name : 'Choose a paint catalog swatch'}</h3>
                    <p className="text-[9px] text-[#cca564] font-medium leading-none mt-1">{activeShade ? activeShade.brand : 'Tap any swatches below to view'}</p>
                    {activeShade && <code className="text-[8.5px] text-ivory/60 font-mono tracking-wider block mt-1">{activeShade.shadeCode}</code>}
                  </div>
                  {activeShade && (
                    <div className="flex flex-col gap-1.5 shrink-0">
                      ...
                      <button 
                        ...
                        className={`px-2 py-1 rounded-md text-[8.5px] font-display uppercase tracking-wider transition-all flex items-center justify-center gap-1 border w-full ${
                          copied ? 'bg-gold border-gold text-white shadow-sm font-semibold' : 'bg-white border-zinc-200 text-ivory/60 hover:border-zinc-300 hover:bg-zinc-50 shadow-xs'
                        }`}
                      >
                        {copied ? (
              ...
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  ...
                  <span className="text-[9px] text-ivory/60 font-medium font-sans">{combination.length}/5</span>
                </div>
                
                {combination.length === 0 ? (
                  <div className="h-[52px] border border-dashed border-[#dfd6c0] rounded-lg flex items-center justify-center bg-transparent">
                    <p className="text-[9px] text-ivory/60 font-medium text-center px-4 leading-normal">
                      ...
                      {combination.map((shade, index) => (
                        ...
                        >
                          ...
                          <div className="bg-[#faf9f6] p-0.5 text-center flex flex-col justify-center items-center h-[24px] border-t border-zinc-100 shrink-0">
                            <span className="text-[5.5px] text-ivory font-bold leading-tight truncate w-full px-0.5">{shade.name}</span>
                          </div>
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                    ...
                    <div className="mt-3.5 space-y-2.5 bg-white border border-zinc-150 p-2.5 rounded-xl">
                      ...
                      <div className="flex flex-col gap-1">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-[7.5px] text-ivory/60 font-mono">Brand Your Blend</span>
                        </div>
                        <input
                          ...
                          className="bg-[#faf9f6]/95 border border-zinc-200 hover:border-zinc-300 focus:border-gold/50 focus:ring-1 focus:ring-gold/15 rounded-lg px-2.5 py-1.5 text-[10px] sm:text-[11px] font-sans font-bold uppercase tracking-widest text-ivory outline-none w-full transition-all"
                        />
                      </div>
            ...
            <div id="ai-color-palettes" className="bg-[#faf9f6]/90 border border-zinc-200 rounded-2xl p-4 shadow-xs mt-2 relative overflow-hidden">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="text-[10px] sm:text-[11px] font-sans font-bold uppercase tracking-widest text-ivory leading-none flex items-center gap-1.5 group-hover/header:text-gold transition-colors">
                      AI Color Theory Harmonies
                      <ChevronDown className={`w-3.5 h-3.5 text-ivory/60 transition-transform duration-300 ${isAiTheoryCollapsed ? '' : 'rotate-180'}`} />
                    </h3>
                    <div className="flex items-center gap-1.5 flex-wrap mt-1">
                      <p className="text-[9px] text-[#cca564] font-medium leading-none">Dynamic combinations from our catalog.</p>
                      {aiSeedShade && (
                        <span className="inline-flex items-center gap-1 text-[9px] bg-gold/10 text-ivory/70 font-medium px-2 py-0.5 rounded-full border border-gold/20 leading-none">
              ...
              {resolvedPresets.map((preset, idx) => (
                ...
                >
                  <div className="w-full">
                    <h4 className="text-[10px] sm:text-[11px] font-sans font-bold uppercase tracking-widest text-ivory mb-1 group-hover:text-gold transition-colors flex items-center justify-between gap-1.5 w-full">
                    ...
                    <p className="text-[9px] text-[#cca564] font-medium leading-snug mb-3.5 h-[28px] overflow-hidden">{preset.desc}</p>
                  </div>
                  ...
                  <div className="w-full">
                    ...
                    <div className="mt-3 pt-2.5 border-t border-zinc-150">
                      <span className="block text-[8px] font-mono text-ivory/60 uppercase tracking-widest mb-1.5 text-center">
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="bg-[#faf9f6]/90 p-0.5 text-center flex flex-col justify-center items-center h-[18px] border-t border-zinc-100 shrink-0 select-none overflow-hidden">
                                <span className="text-[5.5px] text-ivory font-bold leading-tight truncate w-full px-0.5">
                                  {shade.shadeCode}
                                </span>
                              </div>
                            </div>
                    ...
                    <div className="mt-3 pt-2 border-t border-zinc-150 flex items-center justify-between gap-1.5 relative w-full leading-none">
                      <span className="text-[8.5px] font-sans font-bold text-ivory/60 uppercase tracking-wider group-hover:text-gold transition-colors">
                        Apply Palette
                      </span>
                      ...
                      <div className="flex items-center gap-1.5 z-20">
                            ...
                            <button
                              ...
                              className={`p-1 rounded-md border transition-all hover:scale-105 active:scale-95 cursor-pointer ${
                                isPresetWishlisted 
                                  ...
                                  : 'bg-white border-zinc-200 text-ivory/60 hover:text-red-500 hover:border-red-100'
                              }`}
                        ...
                        <button
                          ...
                          className="p-1 rounded-md border bg-white border-zinc-200 text-ivory/60 hover:text-gold hover:border-gold/30 hover:bg-gold/5 transition-all hover:scale-105 active:scale-95 cursor-pointer"
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-left">
                    <span className="text-[10px] sm:text-[11px] font-sans font-bold uppercase tracking-widest text-ivory block group-hover:text-gold transition-colors">
                      Custom Color Matcher
                    </span>
                    <span className="text-[9px] text-[#cca564] font-medium leading-none block mt-1">
                                  ...
                                  <div className="min-w-0">
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      <button
                                        ...
                                        className="text-[8.5px] font-semibold text-ivory/50 border border-zinc-250 bg-zinc-50 hover:bg-zinc-100 px-1.5 py-0.5 rounded leading-none transition-colors"
                                      >
                                        Native Pick
                                      </button>
                                      <input
                                ...
                                {colorAdjustTab === 'hsl' ? (
                                  <div className="space-y-2.5">
                                    ...
                                    <div className="space-y-0.5">
                                      <div className="flex justify-between items-center text-[8px] font-semibold text-ivory/60 uppercase tracking-wider">
                            ...
                            <div className="space-y-1.5 border-t border-zinc-100 pt-3">
                              ...
                              <div className="grid grid-cols-4 gap-2">
                                ...
                                >
                                  ...
                                  <span className="text-[7.5px] font-semibold text-ivory/60 block text-center truncate">Lighter (+12%)</span>
                                </button>
                                {/* Darker */}
                                <button
                                  type="button"
                                ...
                                >
                                  ...
                                  <span className="text-[7.5px] font-semibold text-ivory/60 block text-center truncate">Darker (-12%)</span>
                                </button>
                                {/* Muted */}
                                <button
                                  type="button"
                                ...
                                >
                                  ...
                                  <span className="text-[7.5px] font-semibold text-ivory/60 block text-center truncate">Softer / Muted</span>
                                </button>
                                {/* Vivid */}
                                <button
                                  type="button"
                                ...
                                >
                                  ...
                                  <span className="text-[7.5px] font-semibold text-ivory/60 block text-center truncate">Vivid / Rich</span>
                                </button>
                              </div>
                            </div>
                          </div>
                                ...
                                >
                                  ...
                                  <div className="p-2 flex flex-col justify-between flex-grow w-full">
                                    ...
                                    <div className="flex justify-between items-center text-[7.5px] mt-1.5 border-t border-zinc-50 pt-1 w-full">
                                      <span className="font-medium text-[7px] text-ivory/60 uppercase">Asian</span>
                              ...
                              matchedShades.berger ? (
                                ...
                                >
                                  ...
                                  <div className="p-2 flex flex-col justify-between flex-grow w-full">
                                    ...
                                    <div className="flex justify-between items-center text-[7.5px] mt-1.5 border-t border-zinc-50 pt-1 w-full">
                                      <span className="font-medium text-[7px] text-ivory/60 uppercase">Berger</span>
                                      <span className="font-bold text-emerald-700 bg-emerald-50 px-1 rounded">
                              ...
                              matchedShades.mrf ? (
                                ...
                                >
                                  ...
                                  <div className="p-2 flex flex-col justify-between flex-grow w-full">
                                    ...
                                    <div className="flex justify-between items-center text-[7.5px] mt-1.5 border-t border-zinc-50 pt-1 w-full">
                                      <span className="font-medium text-[7px] text-ivory/60 uppercase">MRF Vapocure</span>
                                      <span className="font-bold text-emerald-700 bg-emerald-50 px-1 rounded">
                ...
                <div className="relative">
                  <div className="flex items-center gap-2 bg-white border border-zinc-200 shadow-3xs rounded-lg px-2.5 h-[32px] transition-all focus-within:border-gold/50 focus-within:ring-1 focus-within:ring-gold/15">
                    ...
                    <input 
                      ...
                      className="bg-transparent w-full border-none py-1.5 text-xs text-ivory focus:outline-none placeholder:text-ivory/60 font-sans min-w-0"
                    />
                    {sSearch && (
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="relative" ref={brandRef}>
                    <button
                      ...
                      className="bg-[#faf9f6]/95 border border-zinc-200 hover:bg-zinc-50 transition-all rounded-lg py-1 px-2.5 text-[10px] font-display font-semibold text-ivory outline-none shadow-sm w-full text-left flex items-center justify-between gap-1 group h-[32px]"
                    >
                      <span className="truncate">
                        <span className="text-ivory/60 font-normal mr-1">Brand:</span>
                          ...
                          <div className="flex flex-col gap-0.5">
                            {BRANDS.map(b => (
                              <button
                                ...
                                className={`text-left px-2 py-1.5 rounded-md text-xs font-medium transition-all duration-300 ${sBrand === b.id ? 'bg-zinc-100 text-ivory font-bold' : 'text-ivory/60 hover:bg-zinc-50 hover:text-ivory'}`}
                              >
                  ...
                  <div className="relative" ref={familyRef}>
                    <button
                      ...
                      className="bg-[#faf9f6]/95 border border-zinc-200 hover:bg-zinc-50 transition-all rounded-lg py-1 px-2.5 text-[10px] font-display font-semibold text-ivory outline-none shadow-sm w-full text-left flex items-center justify-between gap-1 group capitalize h-[32px]"
                    >
                      <span className="truncate">
                        <span className="text-ivory/60 font-normal mr-1">Family:</span>
                          ...
                          <div className="flex flex-col gap-0.5">
                            {FAMILIES.map(f => (
                              <button
                                ...
                                className={`text-left px-2 py-1.5 rounded-md text-xs font-medium capitalize transition-all duration-300 ${sFamily === f ? 'bg-zinc-100 text-ivory font-bold' : 'text-ivory/60 hover:bg-zinc-50 hover:text-ivory'}`}
                              >
                ...
                <div className="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-6 xl:grid-cols-8 2xl:grid-cols-10 gap-1.5 sm:gap-2.5 content-start">
                  ...
                  {shades.length === 0 && !loading && (
                    <div className="col-span-full py-12 flex flex-col items-center justify-center text-center px-4">
                      ...
                      <h4 className="text-[10px] sm:text-[11px] font-sans font-bold uppercase tracking-widest text-[#cca564] mb-1">
                        {sFamily === 'favorites' ? 'No Favorites Saved' : 'No Shades Found'}
                      </h4>
                      <p className="text-[10px] text-ivory/60 max-w-[160px] leading-relaxed">
                        {sFamily === 'favorites' 

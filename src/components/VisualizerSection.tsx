...
export default function VisualizerSection() {
  ...
  const [activeControlTab, setActiveControlTab] = useState<'explore' | 'palette' | 'ai'>('explore');
              ...
              >
                {visualizerMode === 'ai' ? (
                  ...
                  <>
                    ...
                    <div id="interactive-2d-showroom-wrapper" className="sticky top-[102px] sm:top-[126px] lg:static z-30 flex flex-col w-[calc(100%+2rem)] -mx-4 sm:mx-0 sm:w-full glass-panel p-0 rounded-none sm:rounded-2xl border-x-0 sm:border-x border-y sm:border-y border-zinc-200 bg-[#faf9f6]/95 backdrop-blur-xl shadow-lg">
                ...
                <div className="flex items-center gap-3 bg-white border border-zinc-150 p-2.5 rounded-xl shadow-3xs">
                  ...
                  {activeShade && (
                    <div className="flex flex-col gap-1.5 shrink-0">
                      ...
                      <Link
                        to={shadeService.getShadeUrl(activeShade)}
